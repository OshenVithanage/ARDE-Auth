...
export default function Accounts() {
    ...
    const handleFileChange = async (e: React.ChangeEvent<HTMLInputElement>) => {
        ...
        try {
            ...
            // Convert to base64 for storing in user metadata
            ...
            <div className="min-h-screen flex">
                ...
                <div className="flex-1 flex items-center justify-center p-8 bg-[var(--background)]">
                    <div className="w-full max-w-md">
                        ...
                        {/* User profile card - Skeletal loading */}
                        <div className="bg-[var(--primary)] border border-[var(--border)] rounded-lg p-2.5 shadow-lg">
                            <div className="flex items-center space-x-4">
                                {/* Profile picture placeholder */}
                                <div className="flex-shrink-0">
                                    <div className="w-16 h-16 rounded-full bg-[var(--secondary)] animate-pulse"></div>
                                </div>

                                {/* User information */}
                                <div className="flex-1 min-w-0">
                                    <div className="h-6 bg-[var(--secondary)] rounded animate-pulse w-3/4 mb-2"></div>
                                    <div className="h-4 bg-[var(--secondary)] rounded animate-pulse w-1/2"></div>
                                </div>
                            </div>
                        </div>

                        {/* Sign out button - matching login button style */}
                        <div className="w-full mt-6 h-10 bg-[var(--secondary)] rounded-lg animate-pulse"></div>

                        {/* Welcome message */}
                        <div className="mt-6 text-center">
                            <div className="h-4 bg-[var(--secondary)] rounded animate-pulse w-2/3 mx-auto"></div>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div className="flex-1 flex items-center justify-center p-8 bg-[var(--background)]">
                <div className="w-full max-w-md">
                    ...
                    <div className="bg-[var(--primary)] border border-[var(--border)] rounded-lg p-2.5 shadow-lg">
                        <div className="flex items-center space-x-4">
                            ...
                            <div className="flex-shrink-0 relative">
                                <div 
                                    className="w-16 h-16 rounded-full bg-[var(--accent-main)] flex items-center justify-center cursor-pointer relative overflow-hidden hover:opacity-90 transition-opacity"
                                ...
                                <div className="absolute inset-0 rounded-full border-2 border-transparent hover:border-white transition-all cursor-pointer"></div>
                            </div>
                    ...
                    <button
                        ...
                        className="w-full mt-6 bg-[var(--accent-main)] text-white py-2 px-4 rounded-lg font-medium hover:bg-[var(--accent-main)]/80 focus:outline-none focus:ring-2 focus:ring-[var(--accent-main)] focus:ring-offset-2 transition-all cursor-pointer"
                    >
                        Sign Out
                    </button>
